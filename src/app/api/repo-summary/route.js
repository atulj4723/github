...
These may include build artifacts, dependencies, environment files, test snapshots, or autogenerated files. 
Only include the names of the folders and files to skip. 
Do not include any explanation or extra text — just return a valid JSON array of strings.
`,
                        },
                    ],
                },
